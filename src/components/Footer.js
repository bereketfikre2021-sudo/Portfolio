        ...
        <div className="footer-content-modern">
          ...
          <div className="footer-social">
            <div className="social-modern">
              <a href="https://dribbble.com/bereket-fikre" target="_blank" rel="noopener noreferrer" className="social-item" aria-label="Dribbble">
                <img 
                  src={`${process.env.PUBLIC_URL || ''}/assets/dribble-svgrepo-com.svg`} 
                  alt="Dribbble - View Bereket Fikre's design portfolio on Dribbble" 
