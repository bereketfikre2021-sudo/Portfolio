          ...
          <div className="footer-social">
            <div className="social-modern">
              ...
              <Tooltip text="Connect on LinkedIn" position="top">
                <a href="https://www.linkedin.com/in/bereket-fikre-graphic-designer" target="_blank" rel="noopener noreferrer" className="social-item" aria-label="LinkedIn (opens in new window)">
