...
- **Reduce unused CSS**: The app uses one large CSS bundle (`src/styles.css`). Tailwind is available for new UI (`src/tailwind.css`, `preflight: false`). To trim legacy CSS, use a post-build PurgeCSS step or gradually migrate sections to Tailwind.
